        ...
        <div class="card border-0">
            <div class="card-header pb-3">
                ...
                <div class="d-flex mt-3">
                    <a href="{{ route('peminjaman.create') }}" class="btn-b text-decoration-none p-0 m-0 py-2 px-3 rounded text-light ms-auto me-3"><i class="bi bi-plus-circle me-3"></i>Tambah Peminjaman</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('peminjaman.edit',['id', $d->id]) }}"><i class="bi bi-person-fill-gear me-2 i-icon"></i>Edit</a></li>
                                            {{-- <li>
